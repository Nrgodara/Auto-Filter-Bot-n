...
ɪ ᴀᴍ ᴘᴏᴡᴇʀғᴜʟ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴍᴏᴠɪᴇ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ ᴡɪᴛʜ ʟɪɴᴋ sʜᴏʀᴛᴇɴᴇʀ. ʏᴏᴜ ᴄᴀɴ ᴜꜱᴇ ᴀꜱ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ᴡɪᴛʜ ʟɪɴᴋ sʜᴏʀᴛᴇɴᴇʀ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ... ɪᴛ'ꜱ ᴇᴀꜱʏ ᴛᴏ ᴜꜱᴇ ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴀꜱ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ɪ ᴡɪʟʟ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ᴍᴏᴠɪᴇꜱ ᴡɪᴛʜ ʏᴏᴜʀ ʟɪɴᴋ ꜱʜᴏʀᴛᴇɴᴇʀ... ♻️</b>"""
...
» sᴛᴇᴘ 2:- ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ <a href=https://gplinks.com/ref/fakeone>https://gplinks.com</a> [ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴏᴛʜᴇʀ sʜᴏʀᴛɴᴇʀ ᴡᴇʙsɪᴛᴇ ]
...
<code>/set_shortlink api.gplinks.com db106dafe5bedeb1beb96d3ea5907abe66545ed3</code>
...
©️ Powered by: <b>{message.chat.title}</b>"""
    ...
    FILE_CAPTION = """[@𝐋ᴏᴋɪ 𝐆ᴏᴅ ᴏғ 𝐌ɪ𝐬ᴄʜɪᴇғ](https://t.me/search_movie_bbot)<i>{file_name}</i>"""
...
- ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ - <a href=https://graph.org/file/93f81a206f428686d04c3.mp4>ʜᴇʀᴇ</a>

- ᴅᴇᴠʟᴏᴘᴇʀ - <a href=https://t.me/fake_one>𝑴𝑨𝑯𝑰®</a>"""
